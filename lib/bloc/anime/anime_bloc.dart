...
class AnimeBloc extends Bloc<AnimeEvent,AnimeState>{
  ...
  AnimeBloc({required repo}):
    ...
    Future <void> _getEpisodes(GetEpisodes event, Emitter<AnimeState> emit)async{
      ...
      // {"id":64223,"anime_id":4,"episode":1122,"episode2":0,"edition":"","title":"","snapshot":"https:\/\/i.animepahe.ru\/snapshots\/069b876a55ac41fbbe3fc992f04297d7902b204a257762ed15a4c2901c21b28f.jpg","disc":"","audio":"jpn","duration":"00:23:51","session":"88cc15701d9466075d81eee854b8d8a9a9a9dc64f409c42c738ef36ec2585d7e","filler":0,"created_at":"2024-10-13 02:54:45"},
      ...
      emit(AnimeState(repo: _repo,episodes: episodes,status:PaheStatus.done, session: event.url.split('/').last,id: datas.first['anime_id']));
      epiPage++;
    ...
    Future<void> _aniPageStarted(StartAniPage event, Emitter<AnimeState> emit) async{
      emit(AnimeState(repo: _repo,session: event.url.split('/').last));
      await _repo.getAnimeInfo(event.url);
      emit(AnimeState(repo: _repo,status: PaheStatus.done,session: event.url.split('/').last));
